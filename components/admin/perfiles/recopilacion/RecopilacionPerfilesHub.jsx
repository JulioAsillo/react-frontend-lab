...
export default function RecopilacionPerfilesHub() {
    ...
    <div style={{
      ...
      <div style={{ textAlign: "center" }}>
        <div style={{ fontSize: 20, fontWeight: 800, color: "var(--text)", letterSpacing: "-0.02em" }}>
          Recopilar Información — Perfiles
        </div>
      ...
      <div style={{ display: "flex", gap: 20, flexWrap: "wrap", justifyContent: "center" }}>
        <HubCard
          icon="🗄"
          label="Base de Datos"
          desc={<>AD, GDH, MOVIPER, Matriz de Rol,<br />Apps y DBs de Perfiles (10 fuentes)</>}
          onClick={() => router.push("/admin/perfiles/recopilacion/base-datos")}
        />
        <HubCard
          icon="📊"
          label="Consolidados"
          desc={<>Consolidado 1 y<br />Consolidado 2</>}
