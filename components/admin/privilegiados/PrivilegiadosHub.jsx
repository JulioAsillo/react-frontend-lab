...
export default function PrivilegiadosHub() {
    ...
    <div style={{
      ...
      <div style={{ display: "flex", gap: 20, flexWrap: "wrap", justifyContent: "center" }}>
        <HubCard
          ...
          desc={<>Carga los datos desde las fuentes:<br />Fuente1, Fuente2, Fuente3, Fuente4</>}
          onClick={() => router.push("/admin/privilegiados/recopilacion")}
        />
        <HubCard
          icon="🔍"
          label="Hallazgos"
        ...
        <HubCard
          icon="📄"
          label="Informe"
          desc={<>Genera el informe .docx<br />de certificación de Privilegiados</>}
          onClick={() => router.push("/admin/privilegiados/informe")}
        />
      </div>
    </div>
  );
