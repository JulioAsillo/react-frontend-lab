...
const preliminares: ColumnDef[] = [
  ...
  { key: "DB Exactus",                header: "DB Exactus",                group: "C4" },
  { key: "DB Exactus Ultimo Login",   header: "DB Exactus Último Login",  group: "C4" },
  { key: "PostCese DB Exactus",       header: "Post Cese DB Exactus",      group: "C4" },

  { key: "Usr SDP",                   header: "Usr SDP",                   group: "C5" },
  { key: "Usr SDP Ultimo Login",      header: "Usr SDP Último Login",     group: "C5" },
  { key: "PostCese SDP App",          header: "Post Cese SDP App",         group: "C5" },
  { key: "DB SDP",                    header: "DB SDP",                    group: "C5" },
  { key: "DB SDP Ultimo Login",       header: "DB SDP Último Login",      group: "C5" },
  { key: "PostCese DB SDP",           header: "Post Cese DB SDP",          group: "C5" },

  { key: "Usr SIT",                   header: "Usr SIT",                   group: "C6" },
  { key: "DB SIT",                    header: "DB SIT",                    group: "C6" },
  { key: "DB SIT Ultimo Login",       header: "DB SIT Último Login",      group: "C6" },
  { key: "PostCese DB SIT",           header: "Post Cese DB SIT",          group: "C6" },

  { key: "Usr NPAC",                  header: "Usr NPAC",                  group: "C7" },
